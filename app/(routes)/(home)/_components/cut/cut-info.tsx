        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border-r border-gray-200 pr-6">
            <h2 className="text-xl font-semibold text-green-600 mb-4">
              Kesim Günü Uyulması Gereken Kurallar
            </h2>
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                <span className="text-green-500 mr-2">•</span>
                <span>
                  Sıranızı beklerken görevlilerin yönlendirmelerine uyunuz.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2">•</span>
              ...
              <li className="flex items-start">
                <span className="text-green-500 mr-2">•</span>
                <span>
                  Hayvanın kesimi için tüm izinlerin alındığından emin olunuz.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2">•</span>
                <span>
                  Kesim işlemi bittikten sonra temizlik ve hijyen kurallarına
                  uyunuz.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2">•</span>
                <span>
                  Kesilen kurbanın etini uygun şekilde paketleyip muhafaza
                  ediniz.
                </span>
              </li>
              <li className="flex items-start">
          ...
          <div className="pl-6">
            ...
            <div className="bg-red-50 p-4 rounded-md border-l-4 border-red-500 mb-6">
              <p className="text-red-700">
                ...
                <span className="font-bold">durdurulmuştur</span> veya{" "}
                <span className="font-bold">henüz başlamamıştır</span>. Lütfen
                görevlilerin yönlendirmelerini takip ediniz.
              </p>
            </div>
            ...
            <div className="bg-yellow-50 p-4 rounded-md border-l-4 border-yellow-500 mb-6">
              ...
              <p>
                Kesim sırası, kayıt yaptırma sırasına göre belirlenmiştir. Tüm
                kayıtlı kurbanlar kesim sırasına göre işleme alınacaktır.
              </p>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-md border-l-4 border-blue-500">
              ...
              <p id="special-note">
                Kurban kesim alanında güvenlik önlemleri artırılmıştır. Lütfen
                yetkililerin uyarılarına dikkat ediniz ve belirlenen alanlarda
                bekleyiniz.
              </p>
            </div>
          </div>
