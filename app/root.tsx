  ...
  return (
      <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-6">
        <div className="w-full max-w-md text-center">
          ...
          <h1 className="text-4xl font-bold mb-2 text-gray-800">{message}</h1>
          <p className="text-lg mb-8 text-gray-600">{details}</p>
          ...
          >
            <svg className="w-5 h-5 mr-2 transition-transform duration-200 group-hover:translate-x-[-2px]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
            </svg>
            <span className="relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-[1px] after:bg-white after:w-0 after:transition-all after:duration-300 hover:after:w-full">
            Ana Sayfaya Dön
          </span>
          </button>
        </div>
